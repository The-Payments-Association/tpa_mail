    ...
    case 2:
      return (
        <MemberSelection 
          ...
          initialSelectedMemberIds={selectedMembers.length > 0 ? selectedMembers.map(member => member.id) : []}
        />
      );
    case 3:
      return (
    ...
    case 4:
      return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-teal-50/30 to-emerald-100/20 p-6 flex items-center justify-center">
          <div className="backdrop-blur-xl bg-white/70 border border-white/20 rounded-3xl shadow-2xl shadow-teal-500/10 p-12 text-center max-w-2xl">
            <div className="w-16 h-16 bg-gradient-to-br from-[#00DFB8] to-[#00B894] rounded-2xl flex items-center justify-center mx-auto mb-6">
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">
              Your {emailTemplates.length} personalised emails are ready to be sent to the selected TPA members.
            </p>
