...
export default function LoadingOverlay({ 
  ...
  forcedDuration = 10000 // 10 seconds default
}) {
  ...
  return (
    <div className="fixed inset-0 z-[9999]  bg-white flex items-center justify-center">
      ...
      {/* Main loading card */}
      <div className="relative backdrop-blur-xl bg-white border border-white/30 rounded-3xl shadow-2xl p-12 text-center max-w-md mx-4 animate-in fade-in duration-500">
        
        {/* Spinner with logo */}
        <div className="w-20 h-20 mx-auto mb-8 relative">
          {/* Outer spinning ring */}
          <div className="absolute inset-0 animate-spin">
            <div className="h-20 w-20 border-4 border-[#00DFB8]/20 rounded-full"></div>
